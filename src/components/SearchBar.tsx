...
const SearchBar: React.FC<SearchBarProps> = ({ onSearch, onLocationRequest }) => {
    ...
    return (
        <div ref={searchRef} className="flex-1 relative">
            <form onSubmit={handleSubmit} className="w-full flex items-center space-x-2 glass-card rounded-full px-4 py-4 transition-all focus-within:bg-white/10 focus-within:shadow-lg focus-within:ring-1 focus-within:ring-white/20">
